...
class ChitChatSystem:
    ...
    def generate_chitchat_response(self, user_input, chat_history=[]):
        ...
        response = self.client.models.generate_content(
            model="gemini-2.0-flash-lite", contents=f"Respond based on the messages if needed, or else just respond as usual. Keep every response short, sweet and concise. Here are the messages: {messages}"
        )
